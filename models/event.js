...
var Event = class Event {
    constructor(data) {
        ...
        this.dateEvent = Intl.DateTimeFormat("en-US", options).format(data.dateEvent?.dateTime)|| undefined;
        this.dateEvent_end = data.dateEvent_end|| undefined;
        this.thumbnail = data.thumbnail;
        this.event_place = data.event_place;
        this.pole_id = data.pole_id;
        this.login_creator = data.login_creator;
        this.date_open = data.date_open|| undefined;
    ...
    updateEventData(newInfos) {
        ...
        this.dateEvent_end = newInfos.dateEvent_end != undefined ? newInfos.dateEvent_end : this.dateEvent_end;
        ...
        this.date_open = newInfos.date_open != undefined ? newInfos.date_open : this.date_open;
